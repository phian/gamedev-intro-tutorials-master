...
void CSampleKeyHander::KeyState(BYTE* states)
{
	if (game->IsKeyDown(DIK_RIGHT))
		...
		mario->SetState(MARIO_STATE_SITDOWN_CHANGE_COLOR);
...
void LoadResources()
{
	...
	sprites->Add(20001, 425, 238, 441, 258, texMario);
	sprites->Add(20002, 4, 237, 21, 258, texMario);

	sprites->Add(20003, 425, 478, 441, 498, texMario);
	sprites->Add(20004, 4, 478, 21, 498, texMario);


	LPANIMATION ani;

	ani = new CAnimation(100); // stand right
	ani->Add(10001);
	animations->Add(400, ani);

	ani = new CAnimation(100); // stand left
	ani->Add(10011);
	...
	CMario::AddAnimation(502);		// sitdown right
	CMario::AddAnimation(503);		// sitdown left
	CMario::AddAnimation(504);		// sitdown right change color
	CMario::AddAnimation(505);		// sitdown left change color
